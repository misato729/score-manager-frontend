  ...
  <p>
    ...
    <section class="card update-card" style="max-width: 800px">
      ...
      <ul>
        ...
        <li>ver.2025.08.13 : 軽微な修正と機能追加を行いました。</li>
        <li>ver.2026.03.23 : 軽微な機能追加を行いました。</li>
        <li>ver.2026.06.02 ：チェックイン完了画面に店舗名が表示されるようになりました。</li>
        <li>ver.2026.06.05 ：設置店舗一覧の並び順を都道府県順に表示されるようにしました。</li>
        <li>ver.2026.06.11 ：設置店舗マップのスマホ版の全画面表示に対応しました</li>
      </ul>
    </section>
